...
const Card = ({title, tourDurationNights, tourDurationDays, imageUrl, imageAlt}: CardProps) => {
  return (
    <div className="relative w-full h-0 pb-[56.25%] sm:pb-[50%] md:pb-[40%] lg:pb-[35%] max-w-[450px] mx-auto overflow-hidden rounded-lg shadow-lg group">
        <Image
          src={imageUrl}
          alt={imageAlt}
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-2 sm:p-3 md:p-4 bg-gradient-to-t from-black/60 to-transparent pointer-events-none">
