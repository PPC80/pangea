  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-50 flex h-auto flex-col rounded-b-[10px] border bg-background",
          (!direction || direction === "bottom") && "inset-x-0 bottom-0 mt-24", 
          direction === "right" && "top-0 right-0 w-screen max-w-80 h-full",
          direction === "top" && "inset-x-0 top-0 mb-24 w-screen transition-height duration-300 ease-in-out",
          className
        )}
        {...props}
      >
